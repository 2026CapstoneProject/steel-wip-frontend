...
import Web_ScenarioReleaseNcCodePage from "../pages/office/Web_ScenarioReleaseHistoryPage/Web_ScenarioReleaseNcCodePage";
...
const webRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "scenario/releasehistory/nccode",
        element: P(<Web_ScenarioReleaseNcCodePage />),
      },
      {
